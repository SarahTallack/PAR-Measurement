...
#define t_int 	320 //Integration time, in ms
						//Options are: 10, 20, 50, 100, 200, 500, 1000, 2000
						//40, 80, 160, 320, 640, 1280
						//default to 50ms

#define AGAIN 	3		//Gain between 0 and 10, corresponds to following values
...
#define AS7341_GPIO               4
  ...
  /**
    The measurement mode of spectrum sensor
  */
  typedef enum {
    eSpm = 0,/**<SPM>*/
    eSyns = 1,/**<SYNS*/
...
uint16_t AS7341_GetLowThreshold(void);
uint16_t AS7341_GetHighThreshold(void);
